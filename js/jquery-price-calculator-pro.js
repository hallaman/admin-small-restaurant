(function($){
    ...
    var JPrice = function(elem, options){
        ...
        this.assets = {
            ...
            sidebar: {
                total: '<div class="total well"><h3>Total: <span class="price"></span></h3><p>*Does not include tax</p></div>',
                summary: '<div class="summary well"><h3>Your order:</h3><div class="itemized-summary"/></div>',
    ...
    JPrice.prototype = {
        ...
        onChange: function(){
            ...
            console.log(this.elem.find('.itemized-summary'));

            if (this.elem.find('.itemized-summary')) {
                this.elem.find('.itemized-summary').html();
            }
